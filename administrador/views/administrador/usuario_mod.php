...
<form action="<?php echo $baseurl;?>administrador/usuario/updateusuario" method="POST">
  ...
  <div class="form-group">
    <div class="row">
  		...
  		<div class="col-md-4"> <input type="text" name="usuario" class="form-control" value="<?php echo $usuario['user_usuario']; ?>" required/></div>
  	</div>
	</div>
  ...
  <div class="form-group">
    <div class="row">
  		...
  		<div class="col-md-4"> <input type="password" name="password" class="form-control" maxlength="10" pattern="([0-9]*)" value="" required/></div>
  	</div>
	</div>
  ...
  <div class="form-group">
    <div class="row">
  		...
  		<div class="col-md-4"> <input type="email" name="email" class="form-control" value="<?php echo $usuario['correo_usuario']; ?>" required/></div>
  	</div>
	</div>
